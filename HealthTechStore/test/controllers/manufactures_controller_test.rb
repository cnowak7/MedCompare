...
class ManufacturesControllerTest < ActionController::TestCase
  ...
  test "should create manufacture" do
    assert_difference('Manufacture.count') do
      post :create, manufacture: { Email: @manufacture.Email, Location: @manufacture.Location, Manufacture: @manufacture.Manufacture, Manufacture: @manufacture.Manufacture, Manufacture: @manufacture.Manufacture, ManufactureID: @manufacture.ManufactureID, Mnaufacture: @manufacture.Mnaufacture, Name: @manufacture.Name, Number: @manufacture.Number, Phone: @manufacture.Phone }
    end
  ...
  test "should update manufacture" do
    patch :update, id: @manufacture, manufacture: { Email: @manufacture.Email, Location: @manufacture.Location, Manufacture: @manufacture.Manufacture, Manufacture: @manufacture.Manufacture, Manufacture: @manufacture.Manufacture, ManufactureID: @manufacture.ManufactureID, Mnaufacture: @manufacture.Mnaufacture, Name: @manufacture.Name, Number: @manufacture.Number, Phone: @manufacture.Phone }
    assert_redirected_to manufacture_path(assigns(:manufacture))
  end
