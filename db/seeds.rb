...
Vendor.create(name: "HealthTech United",
				...
				searchTags: "wearable, MRI, United, healthTech",
...
Vendor.create(name: "Tech-For-Health Foundation",
				...
				searchTags: "x-ray, ultrasound, pregnancy, baby, heart, bursitis",
...
Vendor.create(name: "Aviato",
				...
				searchTags: "mri, best, health, tech, heart, blood pressure",
...
Vendor.create(name: "Health-To-The-Tech LLC",
				...
				searchTags: "pricate, affordable, reliable, xray, mri, ultrasound",
