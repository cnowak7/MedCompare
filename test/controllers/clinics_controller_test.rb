...
class ClinicsControllerTest < ActionController::TestCase
  ...
  test "should create clinic" do
    assert_difference('Clinic.count') do
      post :create, clinic: { email: @clinic.email, name: @clinic.name, phone_number: @clinic.phone_number, rating: @clinic.rating }
    end
  ...
  test "should update clinic" do
    patch :update, id: @clinic, clinic: { email: @clinic.email, name: @clinic.name, phone_number: @clinic.phone_number, rating: @clinic.rating }
    assert_redirected_to clinic_path(assigns(:clinic))
  end
