...
class ManufacturersControllerTest < ActionController::TestCase
  ...
  test "should create manufacturer" do
    assert_difference('Manufacturer.count') do
      post :create, manufacturer: { email: @manufacturer.email, name: @manufacturer.name, phone_number: @manufacturer.phone_number }
    end
  ...
  test "should update manufacturer" do
    patch :update, id: @manufacturer, manufacturer: { email: @manufacturer.email, name: @manufacturer.name, phone_number: @manufacturer.phone_number }
    assert_redirected_to manufacturer_path(assigns(:manufacturer))
  end
